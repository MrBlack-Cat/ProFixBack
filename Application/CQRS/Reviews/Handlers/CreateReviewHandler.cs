...
//            var dto = request.Dto;
//            var clientProfile = await _unitOfWork.ClientProfileRepository.GetByIdAsync(dto.ClientProfileId);
...
//            newReview.ClientName = $"{clientProfile.Name} {clientProfile.Surname}";
//            newReview.ClientAvatarUrl = clientProfile.AvatarUrl;
